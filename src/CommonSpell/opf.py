...
from CommonSpell.utils.opf_utils import (
    OPCursor,
...
from CommonSpell.weighers.token_weigher_op_confidence import OPConfidenceTokenWeigher
from CommonSpell.weighers.token_weigher_valid_bo import ValidBoTokenWeigher

logger = logging.getLogger("OpfCommonSpeller")


class OpfCommonSpeller():
