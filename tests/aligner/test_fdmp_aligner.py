...
def test_fdmp_aligner():
    ...
    token_lists = [
        ...
        [(0, 4, 1, 'བཀྲ་'), (4, 8, 1, 'ཤིས་'), (8, 12, 1, 'ཀུད་'), (12, 16, 1, 'གྱི་'), (16, 20, 1, 'བཀྲ་'), (20, 24, 1, 'ཤིས་'), (24, 25, 0, 'པ'), (25, 26, 1, '།')],
        [(0, 4, 1, 'བཀྲ་'), (4, 8, 1, 'ཤིས་'), (8, 12, 1, 'ཀུན་'), (12, 16, 0, 'ཀྱི་'), (16, 20, 1, 'བཀྲ་'), (20, 24, 1, 'ཤིས་'), (24, 25, 0, 'པ'), (25, 26, 1, '།')]
    ]
